...
let greetingList1 = ["Ali", "Haris", "Rafay", "Hassan"];

function greeting(greetingList1:string) {
    console.log(`Dear ${greetingList1}, you're invited for the dinner tonight`)
}
...
greetingList1.shift(); greetingList1.shift(); greetingList1.shift();
greetingList1.pop(); greetingList1.pop();